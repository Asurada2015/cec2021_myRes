...
public class MOEAD_AENT extends Algorithm {
     ...
     */
    public MOEAD_AENT(ProblemSet problemSet) {
        super(problemSet);
...
//                    if (maxEvaluations % 1000 == 0){
                    if (tranRand <= 0.1){
                        ...
                        double[][] trans = etmo.metaheuristics.autoencoder.Utils.MappingViaAE(population_, t, task, populationSize_, child);
